...
<div align="center">
	...
	<c:if test="${paging.startPageNo ne paging.firstPageNo }">
		<a
			href="/admin/management/counsel/counsel_seller_list.ja?p=${paging.firstPageNo}&type=${params.type }&value=${params.value}&state=${params.state}&reply=${params.reply}&sort=${params.sort}">&lt;&lt;</a>
	</c:if>
	...
	<c:if test="${paging.endPageNo ne paging.finalPageNo }">
		<a
			href="/admin/management/counsel/counsel_seller_list.ja?p=${paging.finalPageNo}&type=${params.type }&value=${params.value}&state=${params.state}&reply=${params.reply}&sort=${params.sort}">&gt;&gt;</a>
	</c:if>
</div>
